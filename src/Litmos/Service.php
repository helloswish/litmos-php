...
class Service
{
     ...
     * @return mixed
     */
    public function get($url, PagingSearch $ps = null, $qs = null)
    {
        return $this->_doRequest($url, 'GET', null, $ps, $qs);
    }
     ...
     */
    private function _doRequest($url, $method, $body = null, PagingSearch $ps = null, $qs = null)
    {
        $full_url = $this->_generateUrl($url, $ps, $qs);
     ...
     * @throws Exception\RuntimeException
     */
    private function _generateUrl($stub, PagingSearch $ps = null, $qs = null)
    {
